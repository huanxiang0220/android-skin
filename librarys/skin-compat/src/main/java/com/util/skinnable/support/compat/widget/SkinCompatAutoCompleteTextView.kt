...
class SkinCompatAutoCompleteTextView @JvmOverloads constructor(
...
) : AppCompatAutoCompleteTextView(context, attrs, defStyleAttr), SkinSupportable, SkinTextColorable {
    ...
    override fun setTextColorId(colorId: Int) {
        mTextHelper.setTextColorId(colorId)
    }
